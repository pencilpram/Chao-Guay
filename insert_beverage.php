    ...
    <div class="py-5" style="height: 100px;">
        <div class="container">
            <div class="row" style="text-align: left;">
                <div class="col-md-1"><a class="btn btn-primary" href="editBeverage.html" style="background-color:#161719; border:1px solid black; color:#161719;"><img src="images/return.png" style="width:40px; height:40px;"></a></div>
            </div>
        </div>
    </div>
    <div class="py-5">
                    ...
                    <form id="c_form-h" method="POST" action="add_beverage.php" enctype="multipart/form-data" style="font-size: 25px; text-align:center;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-3" style="display: flex; justify-content: center; align-content: center; flex-direction: column;">
                                <input class="form-control" type="file" name="bevimage" style="background-color: #161719; color:#EDB63C; font-size:22px;width:730px;">
                            </div>
                        </div>
